...
export default function AppHeader() {
  ...
  <span style={{ fontSize: 22, color: C.teal }}>📊</span>
  <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
    <span style={{ fontSize: 13, fontWeight: 900, color: "#ffffff", letterSpacing: "0.3px", lineHeight: 1.3 }}>IPO企業情報AI分析レポート</span>
    <span style={{ fontSize: 10, fontWeight: 500, color: "#a0d4d6", letterSpacing: "0.3px", lineHeight: 1.3 }}>担当：大手町調査室九課</span>
  </div>
</Link>
