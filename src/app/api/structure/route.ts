...
2. その表が存在しない場合（株主数が少ない非上場企業からの新規上場でよくあります）は、次の手がかりから株主を推測して構成してください：
   ...
   特に重要：創業者個人と、その資産管理会社（「株式会社〇〇」のような名前）は、たとえ「所有株式数に資産管理会社の分を含む」という注記があっても、必ず別々の株主として2行に分けて出力してください（1人にまとめないでください）。按分する際は、「所有者別状況」の「その他の法人」の比率・株主数を資産管理会社に、「個人」の比率・株主数を創業者個人に割り当てて、それぞれの推定保有株式数・推定持株比率を計算してください。
