  ...
  : null;
    ...
    const featuredBanner = featured ? `
      <div style="background:linear-gradient(135deg,#0d4f52,#2a7a7e);border-radius:12px;padding:16px 20px;margin-bottom:20px">
        ...
        ${featuredGrade ? `<span style="display:block;margin-top:4px;font-size:10px;color:rgba(255,255,255,0.8)">※独自AIナインクロスによる評価</span>` : ''}
      </div>
    ` : '';
          ...
          <div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:24px;background:#f4fbfc">
            ...
            <div style="background:#f4fbfc;padding:20px 24px">
              ...
              <div style="margin-top:16px;padding:14px 16px;background:#fff7ed;border:1px solid #fed7aa;border-radius:10px;text-align:center">
                <p style="margin:0 0 8px;font-size:12px;color:#92400e;font-weight:700">🎁 友達を紹介すると、あなたも友達も有料分析が2ヶ月間読み放題</p>
