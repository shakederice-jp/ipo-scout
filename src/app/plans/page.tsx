...
export const metadata: Metadata = {
  ...
  description: "IPO企業情報AI分析レポートの料金プラン一覧。無料会員・通知プラン・レポート無制限・コンプリートパックの4プランをご用意。",
};
...
const plans = [
  {
    // 2026/9/12改修: 「無料」という名称だと、ログイン不要で読める「無料公開レポート
    // (毎月最初の2銘柄)」と混同されやすいため、「ログインするだけの会員登録」で
    // あることが伝わる「無料会員」に変更(サイト全体のフリー/有料導線見直しの一環)。
    id: "free",
    name: "無料会員",
    price: "¥0",
    period: "",
    ...
    features: [
      ...
      // 2026/9/12追加: お気に入り登録・100万円投資シミュレーション・友達紹介は、
      // 課金の有無にかかわらずログイン(無料会員登録)さえすれば全プラン共通で
      // 使える機能であることを明示(サイト全体のフリー/有料導線見直しの一環)。
      { label: "お気に入り登録（銘柄・記事）", value: "あり", ok: true },
      { label: "100万円投資シミュレーション", value: "あり", ok: true },
      { label: "友達紹介プログラム（有料分析2ヶ月読み放題）", value: "あり", ok: true },
...
const faqs = [
  ...
  // 「無料公開レポート(ログイン不要)」を混同させる原因になっていたため、両者を明確に
  // 分けて説明する内容に修正(サイト全体のフリー/有料導線見直しの一環)。
  { q: "無料会員に期限はありますか？", a: "ありません。メールアドレスだけで登録でき、期限なく無料でご利用いただけます（お気に入り登録・100万円投資シミュレーション・友達紹介プログラムなど）。なお、分析レポート自体は、毎月最初の2銘柄はログイン・登録不要でどなたでもお読みいただけます。" },
  { q: "「無料会員登録」と「無料で読めるレポート」は何が違いますか？", a: "「無料で読めるレポート」は、毎月最初の2銘柄の分析レポートを指し、ログイン不要でどなたでも閲覧できます。一方「無料会員登録」はメールアドレスでのログインを指し、登録すると3銘柄目以降は読めませんが、代わりにお気に入り登録・100万円投資シミュレーション・カレンダーメモ・友達紹介特典（有料分析が2ヶ月間読み放題）がご利用いただけるようになります。" },
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13, minWidth: 560 }}>
                ...
                <tbody>
                  {[
                    ...
                    { label: "お気に入り登録・100万円シミュレーション", values: ["✅", "✅", "✅", "✅"] },
                    { label: "友達紹介プログラム",   values: ["✅", "✅", "✅", "✅"] },
