...
const plans = [
  {
    ...
    features: [
      ...
      { label: "友達紹介プログラム（2ヶ月無料）", value: "あり", ok: true },
...
const faqs = [
  ...
  { q: "「無料会員登録」と「無料で読めるレポート」は何が違いますか？", a: "「無料で読めるレポート」は、毎月最初の2銘柄の分析レポートを指し、ログイン不要でどなたでも閲覧できます。一方「無料会員登録」はメールアドレスでのログインを指し、登録すると3銘柄目以降は読めませんが、代わりにお気に入り登録・100万円投資シミュレーション・カレンダーメモ・友達紹介特典（2ヶ月無料）がご利用いただけるようになります。" },
