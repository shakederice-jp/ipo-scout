  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor:"#f4fbfc",
      ...
      <main className="max-w-6xl mx-auto px-4 py-6 flex flex-col lg:flex-row gap-6 items-start">
        ...
        {/* 左：銘柄一覧 */}
          <a href="/calendar" style={{ display:"flex", alignItems:"center", justifyContent:"center", gap:8, padding:"14px 24px", backgroundColor:"#0d4f52", color:"white", textDecoration:"none", borderRadius:10, fontWeight:700, fontSize:15, marginBottom:16 }}><span style={{ fontSize:18 }}>📅</span> IPOカレンダーを見る →</a>
